    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-2 items-center">
        ...
        <div className="relative w-full h-full order-1">
          {/* India Map */}
          <div ref={mapRef} className="relative pt-10 lg:pt-2 mb-4">
          ...
          <div className="absolute w-full h-full">
            <div className="relative w-full h-full">
              ...
              <p className="absolute right-[6%] top-[15%] text-sm font-semibold text-gray-600">70% Students lack Industry relevant Skills</p>
              ...
              <p className="absolute right-[2%] top-[25%] w-1/2 text-sm font-semibold text-gray-600">40% Students forced to choose the wrong career path</p>
              ...
              <p className="absolute right-[12%] bottom-[7%] w-1/2 text-sm font-semibold text-gray-600">70% Students lack Industry relevant Skills</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12 order-2 mt-8">
          ...
          <div ref={solutionsRef} className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-2 px-2">
              ...
              <div className="flex flex-col items-center relative rounded-md h-8 sm:h-10 px-3 sm:px-6 py-1.5 sm:py-2 shadow-md bg-white/90 hover:shadow-lg transition-all duration-300">
                <div className="mb-2 sm:mb-3 ">
                  <h3 className="text-sm text-nowrap sm:text-base lg:text-lg font-bold text-black">Industry Relevant Skills</h3>
              ...
              <div className="flex flex-col items-center relative rounded-md h-8 sm:h-10 px-3 sm:px-4 py-1.5 sm:py-2 shadow-md bg-white/90 hover:shadow-lg transition-all duration-300">
                <div>
                  <h3 className="text-sm text-nowrap sm:text-base lg:text-lg font-bold text-black">Passion Aligned Opportunity</h3>
