        ...
        <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-[12%] order-2 mt-8">
          ...
          <div ref={solutionsRef} className="space-y-2">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-600 text-center lg:text-left"> With two simple solutions:</h2>
            </div>
