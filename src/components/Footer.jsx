                ...
                <div className="flex flex-col mt-4">
                    ...
                    <div className="flex gap-12 ml-1">
                        <a 
                            ...
                            target='_blank' 
                            rel="noopener noreferrer" 
                            className="text-[#0A66C2] transition-colors duration-300"
                        >
                        ...
                        <a 
                            ...
                            target='_blank' 
                            rel="noopener noreferrer" 
                            className="text-[#E1306C] transition-colors duration-300"
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="text-[#FF0000] transition-colors duration-300"
                        >
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
