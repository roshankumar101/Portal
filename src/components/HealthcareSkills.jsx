...
const HealthcareSkills = () => {
  ...
  return (
    <div className="flex gap-16 mt-12 flex-wrap font-sans max-w-6xl mx-auto px-4">
      ...
      <div ref={clinicalSkillsRef} className="flex-1 min-w-[300px] bg-white/90 shadow-md rounded-xl p-5">
        <div className="mb-6 h-full">
          <div className="text-center mb-8 border-b-1">
            <h3 className="text-2xl font-bold mb-4">Clinical & Technical Mastery</h3>
          </div>
          <div className="space-y-8 text-start text-sm px-6">
            ...
            >
              <div className="flex items-start">
                <div>
                  <h4 className="text-lg font-semibold mb-1 underline decoration-2 underline-offset-1">Zero-Cost Clinical Talent</h4>
      ...
      <div ref={besideExcellenceRef} className="flex-1 min-w-[300px] bg-white/90 shadow-md rounded-xl p-5">
        <div className="mb-6 h-full">
          <div className="text-center mb-8 border-b-1">
            <h3 className="text-2xl font-bold mb-4">Beside Excellence</h3>
          </div>
            ...
            >
              <div className="flex items-start">
                <div>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold bg-gray-50 px-2 py-1 rounded">40% faster response times</span> during code blues and rapid responses compared to average new hires.</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="flex items-start">
                <div>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold bg-gray-50 px-2 py-1 rounded">30% fewer safety incidents</span> due to proactive risk identification and mitigation.</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="flex items-start">
                <div>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold bg-gray-50 px-2 py-1 rounded">50% faster protocol adoption</span> when implementing new clinical guidelines or technology.</p>
                </div>
              </div>
            </div>
          </div>
