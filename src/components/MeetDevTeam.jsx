...
// Placeholder images
const placeholderImgMentor = "https://via.placeholder.com/224x224.png?text=Mentor+Image";
const placeholderImgDev = "https://via.placeholder.com/112x112.png?text=Dev+Image";
...
const devs = [
  ...
  },
  {
    ...
    linkedin: "#",
    role:
      "Join us and help shape the future of the portal! We're always looking for passionate developers to join our team.",
    img: placeholderImgDev,
  },
];
...
const DevHoverCard = ({ name, linkedin, img }) => (
      ...
      <div className="max-w-6xl mx-auto py-10">
        ...
        <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-10">
          {devs.map((dev) => (
            ...
            >
              <DevHoverCard name={dev.name} linkedin={dev.linkedin} img={dev.img} />
