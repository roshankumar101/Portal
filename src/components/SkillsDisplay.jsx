...
const SkillsDisplay = () => {
  ...
  return (
    <div className="flex gap-16 mt-12 flex-wrap font-sans max-w-6xl mx-auto px-4">
      {/* Hard Skills Column */}
      <div ref={hardSkillsRef} className="flex-1 min-w-[300px] bg-white shadow-md rounded-xl p-5">
      ...
      {/* Soft Skills Column */}
      <div ref={softSkillsRef} className="flex-1 min-w-[300px] bg-white shadow-md rounded-xl p-5">
        <div className="mb-6 h-full">
          <div className="text-center mb-8 border-b-1">
