          ...
          <div ref={mapRef} className="relative pt-10 lg:pt-0 mb-4 w-full h-full">
            ...
            <div ref={factsRef} className="absolute w-full h-full">
              <div className="relative w-full h-full">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute right-[18%] -top-[22%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="2" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 6" transform="rotate(273, 400, 400)"><path d="M350.5 350.5Q410.5 384.5 449.5 449.5 " markerEnd="url(#SvgjsMarker1820)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker1820"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute right-[25%] -top-[30%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="2" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 6" transform="rotate(284, 400, 400)"><path d="M350.5 350.5Q410.5 384.5 449.5 449.5 " markerEnd="url(#SvgjsMarker1829)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker1829"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute right-[17%] top-[16%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="2" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 6" transform="rotate(351, 400, 400)"><path d="M350.5 350.5Q447.5 370.5 449.5 449.5 " markerEnd="url(#SvgjsMarker2041)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker2041"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute right-[36%] top-[48%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="2" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 6" transform="rotate(344, 400, 400)"><path d="M350.5 350.5Q362.5 419.5 449.5 449.5 " markerEnd="url(#SvgjsMarker2158)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker2158"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
            ...
            <div className="flex lg:flex-row flex-col justify-between items-center gap-4 sm:gap-2 px-2">
              ...
              <div className="relative rounded-md px-4 sm:px-10 py-1.5 shadow-md bg-white/80 hover:shadow-lg transition-all duration-300">
                <div>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="absolute w-[90%] -top-[34%] -left-[21%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="7" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="matrix(0.9455185755993168,0.32556815445715664,-0.32556815445715664,0.9455185755993168,147.0198315431359,-108.43469202258939)"><path d="M347.5 347.5Q359.5 445.5 452.5 452.5 " markerEnd="url(#SvgjsMarker2436)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker2436"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
                </div>
              </div>
              ...
              <div className="relative rounded-md px-3 sm:px-10 py-1.5 shadow-md bg-white/90 hover:shadow-lg transition-all duration-300">
                <div>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="absolute w-[90%] -top-[35%] -right-[22%]" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><g strokeWidth="7" stroke="hsl(0, 0%, 0%)" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="matrix(0.32556815445715676,0.9455185755993167,-0.9455185755993167,0.32556815445715676,658.980168456864,-108.43469202258939)"><path d="M347.5 347.5Q446.5 365.5 452.5 452.5 " markerEnd="url(#SvgjsMarker2056)"></path></g><defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" viewBox="0 0 5 5" orient="auto" id="SvgjsMarker2056"><polygon points="0,5 1.6666666666666667,2.5 0,0 5,2.5" fill="hsl(0, 0%, 0%)"></polygon></marker></defs></svg>
                </div>
              </div>
